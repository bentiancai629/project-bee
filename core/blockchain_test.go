...
func TestAddBlockToHigh(t *testing.T) {
	...
	assert.Nil(t, bc.AddBlock(randomBlockWithSignature(t, 1, getPrevBlockHash(t, bc, uint32(1))))) // 添加高度 1
	assert.NotNil(t, bc.AddBlock(randomBlockWithSignature(t, 3, types.Hash{})))  // 添加高度不正确
}
